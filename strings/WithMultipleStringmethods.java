...
public class WithMultipleStringmethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("Checking equal of str and str1: "+str.equals(str1));
		...
		System.out.println("Replacing 'H' in str with 'x': "+str.replace('e','x'));
		System.out.println("Replacing all 'i' in str with 'x': "+str.replaceAll("o","x"));
		System.out.println("Replacing first 'i' in str with 'x': "+str.replaceFirst("e","x"));
